...
### Telegram-бот
- Локальный Python-процесс на ПК. Long polling Telegram + WebSocket-мост на `ws://127.0.0.1:8765`.
- Управление YouTube с телефона: play/pause toggle, перемотка ±10/±30/±60, скип спонсора, старт/конец записи рекламы, очистка сегментов, статус.
